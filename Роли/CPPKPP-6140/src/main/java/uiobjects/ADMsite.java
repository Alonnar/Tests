...
public class ADMsite extends WebSite {
    ...
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[9]/div[2]/div/div[2]")
    public static ChangeRoll changeRoll;
    ...
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[7]/div[2]/table/thead/tr[2]/th[12]/div/span[1]")
    public static ClickB clickB15;
