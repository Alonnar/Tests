...
public class ADMSite extends WebSite {
    ...
    @JPage(url = "http://192.168.0.112:91/ADM.WebSite/Security/Roles", title = "Users")
...
public static Form clickrole;
    ...
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[4]/button")
    public static Form addrole;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[8]/div[2]/div/div[2]")
    public static AddRoll addRoll;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[5]/div[2]/table/tbody/tr[1]/td[7]/input")
    public static Form clickcheck;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[3]/button[1]")
    public static Form clicksave2;
