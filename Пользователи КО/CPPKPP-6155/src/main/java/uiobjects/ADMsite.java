...
public class ADMsite extends WebSite {
    ...
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[4]/div[2]/table/tbody/tr[1]/td[2]/a")
    public static ClickB clickB1;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[9]/div[2]/div/div[2]/div[1]/div[2]/div/table/tbody/tr[10]/td[1]/input")
    public static ClickB clickCheckbox;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[9]/div[2]/div/div[2]/div[2]/button[2]")
    public static ClickB savechange;
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[3]/div[1]/div[2]/button[1]")
    public static ClickB saveall;
