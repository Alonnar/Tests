...
public static void setUp() throws Exception {
    ...
    userKO.open();
    clickB1.clickCenter();
    search.login(SearchUser.DEFAULT); //ввод значения
clickCheckbox.clickCenter();
    savechange.clickCenter(); // сохранить изменения в окне
    saveall.doubleClick(); //сохранить изменения
    saveall.doubleClick();
