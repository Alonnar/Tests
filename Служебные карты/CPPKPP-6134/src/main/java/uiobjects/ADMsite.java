...
import factaries.Edit;
import factaries.Search;
...
public class ADMsite extends WebSite {
    ...
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[9]/div/div[3]/table/tbody/tr[1]/td[12]/span")
    public static ClickB1 clickB1;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[9]/div/div[3]/table/tbody/tr[1]/td[12]")
    public static ClickB1 clickB2;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[3]/div[1]/div/div/a")
    public static ClickB1 clickB3;

    @FindBy(css ="/html/body/div[1]/div[3]/div[3]/div[2]/div")
    public static Edit edit;

    @FindBy(css ="/html/body/div[1]/div[3]/div[4]/div[2]/div/div[2]")
