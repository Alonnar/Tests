...
public class ADMsite extends WebSite {
    ...
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[9]/div/div[3]/table/tbody/tr[1]/td[14]")
    public static ClickB1 clickB1;

    @FindBy(xpath = "/html/body/div[1]/div[3]/div[9]/div/div[3]/table/tbody/tr[1]/td[14]/span")
    public static ClickB1 clickB2;
    @FindBy(xpath = "/html/body/div[1]/div[3]/div[7]/div[2]/div/div[2]/div[2]/button")
